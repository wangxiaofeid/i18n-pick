...
// const fileList = ["hitrule.js","riskRatio.js","systemFact.js","objectFact.js","extendFact.js","entering.js","history.js","platformIndex.js","challengeHistory.js","challengeStatistic.js","challengeHitrule.js","feSnippet.js","api.js"];

function run(path) {
    glob(`${path}/**/*.{js,jsx,vm}`, { ignore: exclude.map(pattern=>`${path}/${pattern}`) }, (error, files) => {
        files.forEach(filename => {
            ...
            // 遍历指定文件
            // if (fileList.indexOf(filename.split('/')[filename.split('/').length - 1]) == -1) {
            //     return
            // } 
            // if (!filename.includes('en_US.vm')) {
            //     return;
            // }
        ...
        // 临时的vm
        // fs.appendFile(`${targetDir}/xxx.json`, `${JSON.stringify(hh)}`,  function(err) {
        //     if (err) {
        //         return console.error(err);
        //     }
        //     console.log(`----去重后中文文案为 ${hh.size} 条----`);
        // });
